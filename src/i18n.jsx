...
const dict = {
  en: {
    ...
    catalogue: {
      ...
      intro: 'Every piece from the printed KA International catalogue, with its reference and dimensions.',
      open: 'Browse the 2026 catalogue',
      count: '{n} pieces from the printed catalogue',
  ...
  ar: {
    ...
    catalogue: {
      title: 'كتالوج ٢٠٢٦',
      intro: 'كل قطعة من كتالوج KA International المطبوع، بمرجعها ومقاساتها.',
      open: 'تصفّح كتالوج ٢٠٢٦',
      count: '{n} قطعة من الكتالوج المطبوع',
      search: 'ابحث بالاسم أو المرجع',
    },
