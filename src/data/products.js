...
export const PRODUCTS = [
  ...
  {
    id: 'brasilia-armchair',
    name: { en: 'Brasilia Armchair', ar: 'كرسي برازيليا' },
    category: 'living',
    price: 6800,
    ...
    signature: true,
    description: {
      en: 'An armless lounge chair on splayed solid-ash compass legs, with a deep bouclé seat and a single reclined back.',
      ar: 'كرسي استرخاء بلا مساند على أرجل مائلة من خشب الدردار الصلب، بجلسة بوكليه عميقة وظهر مائل من قطعة واحدة.',
    },
    materials: { en: 'Solid ash frame, bouclé or Italian fabric', ar: 'هيكل دردار صلب، بوكليه أو قماش إيطالي' },
    dims: { en: 'W 68 × D 72 × H 74 cm', ar: 'عرض ٦٨ × عمق ٧٢ × ارتفاع ٧٤ سم' },
    // Pale oak leads here — the Brasilia is shown in natural ash, not walnut —
    // and carries no surcharge, so the listed price stays the base price.
    options: {
      fabric: FABRICS,
      leather: LEATHERS,
      wood: [{ ...WOODS[1], delta: 0 }, { ...WOODS[0], delta: 0 }, { ...WOODS[2], delta: 250 }],
    },
...
export const ROOMS = [
  {
    ...
    products: ['meridian-sofa', 'brasilia-armchair', 'oasis-coffee-table', 'crescent-sideboard'],
    hotspots: [
      { productId: 'meridian-sofa', x: 42, y: 62 },
      { productId: 'brasilia-armchair', x: 74, y: 58 },
